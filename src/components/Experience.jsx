        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
              ...
              <div className="font-bold text-gray-900 dark:text-slate-100">{exp.duration}</div>
            </div>
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
              <MapPin className="w-6 h-6 mb-2 text-blue-600" />
              <div className="text-sm text-gray-600 dark:text-slate-400">Location</div>
              <div className="font-bold text-gray-900 dark:text-slate-100">{exp.location}</div>
            </div>
          </div>
              ...
              {exp.roleProgression.map((role, idx) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-slate-400 font-medium">{role.duration}</span>
                  </div>
          ...
          {/* Key Projects */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">Key Projects</h3>
            <ul className="space-y-2">
          ...
          {/* Achievements */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-3">Achievements</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
              ...
              <div className="font-bold text-gray-900 dark:text-slate-100">{exp.details.teamSize}</div>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-teal-50 dark:from-slate-800 dark:to-slate-900 rounded-lg p-4 border border-blue-200 dark:border-slate-700">
              <Zap className="w-6 h-6 mb-2 text-blue-600" />
              <div className="text-sm text-gray-600 dark:text-slate-400">Impact</div>
              <div className="font-bold text-gray-900 dark:text-slate-100 text-sm">{exp.details.impact}</div>
            </div>
          </div>
        </div>
                  ...
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                    <div className="group bg-white/70 dark:bg-slate-900/70 backdrop-blur-md rounded-2xl p-5 sm:p-6 shadow-xl border border-gray-200 dark:border-slate-700 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 sm:hover:scale-105">
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        {/* Company Logo */}
                        <div className="flex-shrink-0 w-16 h-16 bg-white dark:bg-slate-900 rounded-lg border-2 border-gray-200 dark:border-slate-700 p-2 flex items-center justify-center">
                          <img
                            src={exp.companyLogo}
                            alt={exp.company}
                            className="w-full h-full object-contain"
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-1">{exp.company}</h3>
                      ...
                      {exp.roleProgression && exp.roleProgression.length > 1 && (
                        <div className="mb-4">
                          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-emerald-900/40 dark:to-green-900/40 border border-green-300 dark:border-emerald-700 rounded-full text-sm font-semibold text-green-700 dark:text-emerald-200">
                            <TrendingUp size={14} />
